...
+ 문수지 : Programmer, Oracle DB의 Procedure/JOB SCHEDULER로 주기적 데이터 관리기능 구현, JQuery/Ajax로 동기식 Alarm기능 및 유효성 검사, Spring MVC/MyBatis/JQuery/Ajax/HTML 이용하여 사용자(학부모) 기능을 구축
