                ...
                <form class="form-horizontal" action="<c:url value='/notice/update'/>" method="post">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <textarea class="form-control" id="noticeContent" name="noticeContent" style="height:20rem;" required>${noticeVO.noticeContent}</textarea>
                            </div>
                        </div>
                        
                        <div class="form-group row">
                        	<label for="llname" class="col-sm-2 text-right control-label col-form-label">상단 고정여부</label>
                            <!-- <label class="col-md-2">상단 고정여부</label> -->
                            <div class="col-md-9">
